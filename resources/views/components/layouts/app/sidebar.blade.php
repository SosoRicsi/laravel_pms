            ...
            <flux:navlist variant="inline">
                ...
                @can('admin')
                    <flux:navlist.group heading="{{ __('Admin') }}" class="grid">
                        <flux:navlist.item icon="shield-user" :href="route('manage-users')" :current="request()->routeIs('manage-users')" wire:navigate>{{ __('Felhasználók Kezelése') }}</flux:navlist.item>
                    </flux:navlist.group>
                @endcan
            </flux:navlist>
                        ...
                        <div class="p-0 text-sm font-normal">
                            <div class="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
                                ...
                                <div class="grid flex-1 text-left text-sm leading-tight">
                                    ...
                                    <span class="truncate text-xs my-2">{{ auth()->user()->email }}</span>
                                    <span class="truncate text-xs">{{ auth()->user()->role->display() }}</span>
                                </div>
                            </div>
                        </div>
                    </flux:menu.radio.group>
